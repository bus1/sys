...
/// Size of the fixed-size hash result the SHA-256 engine produces. The size is
/// given in bytes.
const SHA256_HASH: usize = 32;

/// Size of the chunks the SHA-256 engine operates on. The size is given in
/// bytes.
const SHA256_CHUNK: usize = 64;

/// SHA-256 engine type that implements a streaming capable hash function
...
/// Initial state of the SHA-256 engine as defined in RFC-6234. It corresponds
...
/// SHA-256 engine constants that are mixed into the SHA-256 engine, as defined
/// in RFC-6234. It corresponds to the first 32 bits of the fractional parts of
...
/// Performs a single step of the SHA-256 engine. It takes the `schedule`
...
/// Performs a full round of the SHA-256 engine. It takes an entire chunk

...
pub trait Engine {
    /// Associated type that represents the result of a hashing function.
...
/// Support type to represent a possible hash value of most hashing functions.
/// This can be used by the hashing functions to implement their hash type, if
